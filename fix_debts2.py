...
legacy_replacement = """
            ...
            for row in raw_records:
                ...
                legacy_row = {
                    ...
                    "Unnamed: 25": clean_val(get_val(row, ["Total Invoice", "Total Amount", "Total", "إجمالي الفاتورة", "الاجمالي", "Unnamed: 25"])),
                    "Unnamed: 27": clean_val(get_val(row, ["Remaining Amount", "Remaining", "Balance", "المتبقي", "الباقي", "Unnamed: 27"]))
                }
...
with open('sync_powerbi_relational.py', 'w') as f:
    f.write(content)
print("Debts 25 and 27 added to patch.")
